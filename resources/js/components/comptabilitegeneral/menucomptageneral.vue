<template>
  <ul id="menu">
    ...
    <li>
      <a href="#" class="drop">Travaux Périodiques</a>
      <!-- Begin 4 columns Item -->
    ...
    <li>
      <a href="#" class="drop">Gestion Trésorerie</a>
      <!-- Begin 4 columns Item -->
